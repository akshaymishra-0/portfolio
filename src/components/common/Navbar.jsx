    ...
    <header className="fixed top-0 left-0 right-0 z-40 px-4 sm:px-8 pt-4 pb-2 transition-all duration-300">
      <div
        ...
        className={`max-w-6xl mx-auto rounded-2xl transition-all duration-300 ${
          isOpen
            ? 'glass-panel-menu shadow-[0_10px_30px_rgba(0,0,0,0.35)] px-5 py-4'
            : isScrolled
            ? 'glass-panel shadow-[0_10px_30px_rgba(0,0,0,0.35)] border-white/10 px-5 py-3'
      ...
      >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700 focus:outline-none transition-colors"
            ...
            <div className="md:hidden mt-4 pt-4 border-t border-slate-800/80 flex flex-col gap-2 animate-fade-in">
              ...
              <div className="pt-2">
                <a
                  href="#contact"
                  onClick={handleLinkClick}
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all"
                >
                  Let's Talk
                  <ArrowUpRight className="w-4 h-4" />
                </a>
